...
def sendMentionFooter(to, mid, firstmessage, lastmessage):
    try:
        ...
        ticket = "https://line.me/ti/p/~12345kkkkk00000"
                            ...
                            dataProfile = [
                                {
                                    ...
                                    "styles": {
                                        ...
                                        "footer": {"backgroundColor": "#CC0000"}, #"separator": True, "separatorColor": "#333333"}
                                    },
                                    "header": {
                                        "type": "box",
                                        "layout": "vertical",
                                        ...
                                        "contents": [
                                            {
                                                "type": "image",
                                                "url": 'https://sv1.picz.in.th/images/2019/02/19/T8K5cJ.gif',
                                                "size": "md"
                                            },
                                            {
                                                "type": "text",
...
#=====================================================================
                ...
                if text.lower() == "me1":
                    contact = maxgie.getContact(sender)
                    sendTemplate(to,{"type":"flex","altText": "👑BÄNKᴮᴼᵀᴸᶤᴺᴱβǾŦ👑","contents":{"type":"bubble","footer":{"type":"box","layout":"horizontal","contents":[{"color":"#FF69B4","size":"xs","wrap":True,"action":{"type":"uri","uri":"line://app/1636169025-yQ7bGMVA?type=profile"},"type":"text","text":"👑BÄNKᴮᴼᵀᴸᶤᴺᴱβǾŦ👑","align":"center","weight":"bold"},{"type":"separator","color":"#FF69B4"},{"color":"#FF69B4","size":"xs","wrap":True,"action":{"type":"uri","uri":"line://ti/p/~12345kkkkk00000"},"type":"text","text":"👑BÄNKᴮᴼᵀᴸᶤᴺᴱβǾŦ👑","align":"center","weight":"bold"}]},"styles":{"footer":{"backgroundColor":"#FFD2E6"},"body":{"backgroundColor":"#00FF00"}},"body":{"type":"box","contents":[{"type":"box","contents":[{"type":"separator","color":"#FF69B4"},{"aspectMode":"cover","gravity":"bottom","aspectRatio":"1:1","size":"sm","type":"image","url":"https://sv1.picz.in.th/images/2019/02/19/T8wxJ2.gif"},{"type":"separator","color":"#FF69B4"},{"type":"image","aspectMode":"cover","aspectRatio":"1:1","size":"sm","url":"https://sv1.picz.in.th/images/2019/02/19/T81mjz.gif"},{"type":"separator","color":"#FF69B4"},{"type":"image","aspectMode":"cover","aspectRatio":"1:1","size":"sm","url":"https://sv1.picz.in.th/images/2019/02/19/T846sy.gif"},{"type":"separator","color":"#FF69B4"},{"type":"image","aspectMode":"cover","aspectRatio":"1:1","size":"sm","url":"https://sv1.picz.in.th/images/2019/02/19/T8K5cJ.gif"},{"type":"separator","color":"#FF69B4"}],"layout":"vertical","spacing":"none","flex":1},{"type":"separator","color":"#FF69B4"},{"type":"box","contents":[{"type":"separator","color":"#FF69B4"},{"color":"#413877","size":"md","wrap":True,"type":"text","text":"MAXGIE BOTS","weight":"bold"},{"type":"separator","color":"#FF69B4"},{"color":"#413877","size":"md","wrap":True,"type":"text","text":"{}".format(contact.displayName),"weight":"bold"},{"type":"separator","color":"#FF69B4"},{"color":"#FF69B4","size":"xs","wrap":True,"type":"text","text":"Status Profile:","weight":"bold"},{"type":"text","text":"{}".format(contact.statusMessage),"size":"xxs","wrap":True,"color":"#422002"}],"layout":"vertical","flex":2}],"layout":"horizontal","spacing":"md"},"hero":{"aspectMode":"cover","margin":"xxl","aspectRatio":"1:1","size":"full","type":"image","url":"https://obs.line-scdn.net/{}".format(contact.pictureStatus)}}})
                elif text.lower() == "/me":
                            s = temp["te"]
                            a = temp["t"]
                            contact = maxgie.getContact(maxgieMID)
                                        ...
                                        "contents": [
                                            {
                                                ...
                                                "contents": [
                                                    ...
                                                    {
                                                        "type": "text",
                                                        "text": "สนใจเช่าบอท คลิกที่นี่",
                                                        "align": "center",
                                                        "color": s,
                                                        "size": "md",
                                                        "action": {
                                                            "type": "uri",
                                                            "uri": "http://line.me/ti/p/~12345kkkkk00000"
                                                        }
                                                    },
                                                    {
                                                        "type": "spacer",
                ...
                if text.lower() == "sp" or text.lower() == "speed":
                    ...
                    try:
                        arr = []
                        owner = "ua55c51f0dff6eef79fbf33e5a67a52c8"
                        ...
                        data = {
                            ...
                            "sentBy": {
                                 "label": "{}".format(maxgie.getContact(maxgieMID).displayName),
                                 "iconUrl": "https://obs.line-scdn.net/{}".format(maxgie.getContact(maxgieMID).pictureStatus),
                                 "linkUrl": "line://ti/p/~12345kkkkk00000"
                            }
                        }
                        sendTemplate(to, data)
        ...
        if op.type == 25 or op.type == 26:
            ...
            if msg.contentType == 0:
                if text is None:
                    return
                if text.lower() == ".":
                    maxgie.sendMessage(to,"👑BÄNKᴮᴼᵀᴸᶤᴺᴱβǾŦ👑\nadmin :\nline://ti/p/~12345kkkkk00000")
#========================================================================
            elif msg.contentType == 7: # Content type is sticker
                if settings['Sticker']:
                    if 'STKOPT' in msg.contentMetadata:
